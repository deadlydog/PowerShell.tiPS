...
$tip.Title = 'Make convenience to objects by using calculated properties'
$tip.TipText = @'
PowerShell is a dynamic language, which means that you can add properties to objects on the fly. By using calculated properties, you can add properties to objects that are calculated from other properties on the object, or data from external sources.

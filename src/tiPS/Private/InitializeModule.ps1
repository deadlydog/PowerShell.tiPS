function InitializeModule
{
	...
	Write-Debug 'Reading all tips from JSON file and storing them in a $UnseenTips variable for access by other module functions.'
	[hashtable] $tipHashTable = ReadAllPowerShellTipsFromJsonFile
	New-Variable -Name 'UnseenTips' -Value $tipHashtable -Scope Script

	Write-Debug 'Removing tips that have already been seen from the $UnseenTips variable.'
	RemoveTipsAlreadySeen -Tips $script:UnseenTips
